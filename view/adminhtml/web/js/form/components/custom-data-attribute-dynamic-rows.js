...
define([
     ...
     */
    let sortValueValidator = function (value) {
    ...
    return dynamicRows.extend({
        ...
        initLinks: function () {
            ...
            Events.on('customDataAttributes:saveAfter', function (data) {
        ...
        /**
         * Open the custom data attribute modal and insert form with the data from selected record.
         *
         * @param {Object} record
         */
        ...
        reInitData: function (data) {
            let recordData = this.recordData().slice();
            let prop = this.identificationProperty;
            let isExists = false;
        ...
        sortByHeader: function (property) {
            ...
            if (property().columnsHeaderClasses) {
                ...
                activeLabel.columnsHeaderClasses = property().columnsHeaderClasses === '_ascend'
                    ? '_descend'
                    : '_ascend';
        ...
        sortRecord: function (sortBy, ascend) {
            this.recordData.sort(function (left, right) {
                let record1 = ascend ? left : right;
                let record2 = ascend ? right : left;
